...
# Менеджеры (Виктория и Максим убраны — больше не в команде)
MANAGERS = {
    12377210: "Никита",
    11176694: "Наталья",
     6461602: "Елена",
...
<p class="subtitle">10–31 июля · Призовой фонд 20 000 ₽ · <span class="days">⏳ {days_left} {_days_ru(days_left)} до финала</span></p>
